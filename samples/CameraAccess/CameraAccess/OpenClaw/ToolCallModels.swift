...
enum ToolDeclarations {
  ...
  static let execute: [String: Any] = [
    "name": "execute",
    "description": "Your only way to take action. You have no memory, storage, " +
      "or ability to do anything on your own -- use this tool for everything: " +
      "sending messages, searching the web, adding to lists, setting reminders, " +
