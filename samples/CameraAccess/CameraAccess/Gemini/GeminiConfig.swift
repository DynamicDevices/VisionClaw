...
enum GeminiConfig {
  static let websocketBaseURL = "wss://generativelanguage.googleapis.com/ws/" +
  ...
  static let defaultSystemInstruction = """
    ...
    create notes, research topics, control smart home devices, interact with apps, and much more.
    ...
    names, content, platforms, quantities, etc. The assistant works better with complete information.
    ...
    and are working on it. The tool may take several seconds to complete, so the \
    acknowledgment lets them know something is happening.
